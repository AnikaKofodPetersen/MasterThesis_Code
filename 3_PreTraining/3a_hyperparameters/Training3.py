...
logfile_PATH = "/home/projects/ht3_aim/people/anipet/new_model_training/logfile3.txt"
models_PATH = "/home/projects/ht3_aim/people/anipet/new_model_training/models3/"
...
#Drop rows with only NESG
df = df.drop(df[(df['NESG_label'] != 6) & (df['PSI_BIO_label'] == 9)].index)
...
#### Plot Accuracy ####
#ax4.plot(x,vr, label = "Average PCC of Validation NESG data", c = "blue", lw = 5)
#ax4.plot(x,tr, label = "Average PCC of Training NESG data", lw = 5, c="red")
#ax4.plot(x,ttr, label = "Average PCC of Testing NESG data", lw = 5, c="cornflowerblue")
